...
@Configuration
@EnableJpaRepositories(basePackages = "com.ims.repositories", entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.ims.model" });
	 ...
	 * @Bean
	 * 
	 * @Autowired private static ObjectMapper createObjectMapper() { System.out.
	 * println("Inside createObjectMapper --------------------------------------------------------"
	 * ); ObjectMapper mapper = new ObjectMapper();
	 * 
	 * mapper.registerModule(new Jdk8Module()); mapper.registerModule(new
	 * JavaTimeModule()); mapper.registerModule(new ParameterNamesModule());
	 * 
